...
const Decrypt = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-col1 to-col3 pt-24 text-white pb-12  ">
        <div className="md:w-4/5 md:mx-auto mx-4 flex flex-col items-center">
        <span className="text-center text-3xl font-bold ">
          Upload your image to decrypt it
        </span>
        ...
        <div>
            <h1 className="text-left text-xl font-medium mt-12 ">
                Enter the key to decrypt the image
            </h1>
            <input
                type="text"
                name="key"
                className="w-full border bg-transparent outline-none focus:none px-2 py-1  border-col4 mt-2 rounded-md cursor-pointer  dark:hover:bg-slate-800 dark:bg-slate-700 hover:border-purple-400 dark:border-gray-600 dark:hover:border-gray-500 "
            />
        </div>
        <Button className=" w-1/4 mt-12 bg-gradient-to-tr from-col4 to-col3  ">Decrypt</Button>
